...
```{r}
ggwordcloud(words = test_positive_sentiments$bigram, freq = test_positive_sentiments$n, random.color = TRUE, colors =  palette_pos, min.freq = 30)
...
```{r}
ggwordcloud(words = positive_review_words$word, freq = positive_review_words$n, random.color = TRUE, colors =  palette_pos, min.freq = 70)
...
```{r}
ggwordcloud(words = positive_no_sentiment_tri$trigram, freq = positive_no_sentiment_tri$n, random.color = TRUE, colors =  palette_pos, min.freq = 150)
```
